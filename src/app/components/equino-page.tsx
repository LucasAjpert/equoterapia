...
export function EquinoPage() {
  const [abaAtiva, setAbaAtiva] = useState<'geral' | 'observacoes'>('geral');
  const [fotoEquino, setFotoEquino] = useState<string | null>(null);
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setFotoEquino(reader.result as string);
      };
  ...
  const handleSave = () => {
    console.log('Salvando equino:', formData);
  };
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50 overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-6">
        <h1 className="text-indigo-700">Equino</h1>
        <p className="text-gray-600 mt-1">Cadastro e gerenciamento de equinos</p>
      </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-center">
                        <div className="relative">
                          <div className="w-32 h-40 border-2 border-dashed border-indigo-300 rounded-lg flex items-center justify-center bg-indigo-50 overflow-hidden">
                            {fotoEquino ? (
                              <img src={fotoEquino} alt="Foto" className="w-full h-full object-cover" />
                            ) : (
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <label className="block text-gray-700 mb-1">Ferradura</label>
                          <select
                            name="ferradura"
                            value={formData.ferradura}
                            onChange={handleChange}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          >
